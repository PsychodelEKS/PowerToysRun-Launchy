...
- Match full paths only through the `ln` keyword, keeping global results focused on file and folder names.
...
Ranking prefers exact and prefix matches over substring matches, files over folders for equal scores, and shorter names over longer names.
